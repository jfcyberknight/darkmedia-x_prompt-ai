/* =============================================
   ...
   Backend : API Laravel (session + magic link)
   ============================================= */
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // Lien magic link expiré ou déjà utilisé → retour ici avec ?login_error=expired
...
function bindLoginForm() {
  // Demande d'un lien de connexion par email (magic link)
...
// l'app, on valide strictement la valeur comme une couleur hex (#rgb, #rrggbb,
// #rrggbbaa) avant interpolation ; toute autre valeur retombe sur la couleur
// d'accent par défaut, empêchant une injection CSS/HTML via style.
